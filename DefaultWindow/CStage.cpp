...
void CStage::Initialize()
{
	...
	// 승리 테스트
	{
		...
		CObjMgr::Get_Instance()->Add_Object(OBJ_PLAYER, CAbstractFactory<CTank>::Create(300.f, 300.f));
	}
...
void CStage::Initalize_Bmp()
{
	...
	CBmpMgr::Get_Instance()->Insert_Bmp(L"../StarCraft/Effect/BattleAtk/Yamato.bmp", L"Yamato");
