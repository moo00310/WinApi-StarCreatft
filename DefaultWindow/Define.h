...
enum OBJID { OBJ_PLAYER, OBJ_BUILD, OBJ_MONSTER, OBJ_EFFECT, OBJ_BUTTON, OBJ_MOUSE, OBJ_END };
...
enum INPUTSTATE { IP_MOVE, IP_ATTACK, IP_HOLD, IP_STOP, IP_PATROL, IP_BUILD, IP_HEAL,IP_END };
