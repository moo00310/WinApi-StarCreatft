...
enum INPUTSTATE { IP_MOVE, IP_ATTACK, IP_HOLD, IP_STOP, IP_PATROL, IP_BUILD, IP_HEAL, IP_Chase, IP_NUKE, IP_YAMTO,IP_END };
enum CURSERSTATE { MS_IDLE, MS_OBJ, MS_OBJ_E, MS_ATTACK, MS_MOVE, MS_DRAG, MS_SCROLL_R, MS_SCROLL_U, MS_SCROLL_L, MS_SCROLL_D,};
